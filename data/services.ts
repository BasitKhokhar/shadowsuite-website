export const services = [
  {
    title: "Android RATs",
    icon: "SmartphoneIcon", // Changed to string
    description: "Cutting-edge Android Remote Access Trojans with full undetectability and live control capabilities.",
  },
  {
    title: "PC RATs",
    icon: "Laptop", // Changed to string
    description: "Powerful PC RATs featuring comprehensive keylogging, screen monitoring, and remote shell access.",
  },
  {
    title: "iOS RAT Access",
    icon: "Apple", // Changed to string
    description: "Exclusive access to advanced Remote Access Trojans designed for iOS devices.",
  },
  {
    title: "One-Tap Link Builds",
    icon: "Zap", // Changed to string
    description: "Custom-engineered one-tap exploit links for instant, zero-install access.",
  },
  {
    title: "Telegram Bot Panel Setup",
    icon: "Bot", // Changed to string

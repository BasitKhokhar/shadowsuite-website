...
import { TextIcon as Telegram, MessageCircle } from "lucide-react"
import Link from "next/link"
import { motion } from "framer-motion" // Import motion

export default function PaymentContactCTA() {
  return (
    <motion.section
    ...
    >
      <div className="container mx-auto text-center bg-card p-8 md:p-12 rounded-lg border-2 border-neon-red shadow-neon-red/50">
        ...
        <motion.p
          ...
          viewport={{ once: true, amount: 0.3 }}
        >
          Contact us directly to get wallet addresses or bank details and finalize your order.
        </motion.p>
